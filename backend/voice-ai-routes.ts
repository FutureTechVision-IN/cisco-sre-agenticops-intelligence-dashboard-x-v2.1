...
import { processEnhancedVoiceCommand, EnhancedVoiceCommandRequest } from "./enhanced-voice-ai-service";
import type { VoiceCommandRequest } from "./voice-ai-service";
...
router.post("/process", async (req, res) => {
  try {
    ...
    // Process with enhanced AI service (v3), returning v2-compatible response
