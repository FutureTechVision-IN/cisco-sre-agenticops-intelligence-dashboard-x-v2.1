...
export interface Anomaly {
  ...
  fieldNotices?: string[]; // Related field notices (e.g., ['FN70496', 'FN70546'])
  metadata?: any; // For summary aggregations
}
...
export interface Prediction {
  ...
  drivers: string;
  subtext: string;
  fieldNotices?: string[]; // Contributing field notices
  metadata?: any; // For summary aggregations
}
...
export interface Recommendation {
  ...
  category: string;
  action: string;
  fieldNotices?: string[]; // Related field notices
  estimatedImpact?: string; // For summary aggregations
  implementationComplexity?: string; // For summary aggregations
  metadata?: any; // For summary aggregations
}
