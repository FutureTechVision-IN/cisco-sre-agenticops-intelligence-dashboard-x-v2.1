 ...
 * API Key: configured via CISCO_CIRCUIT_API_KEY environment variable
 */

if (!process.env.CISCO_CIRCUIT_API_KEY) {
  console.error('[cisco-circuit] CISCO_CIRCUIT_API_KEY is not set. Set it in .env before starting.');
}
